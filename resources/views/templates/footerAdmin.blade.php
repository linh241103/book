<div class="footer_part">
    ...
    <script src="{{ asset('js/jquery1-3.4.1.min.js') }}"></script>{{ asset('') }}
    ...
    <!-- Mirrored from demo.dashboardpack.com/sales-html/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jul 2023 14:17:35 GMT -->
    </html>
